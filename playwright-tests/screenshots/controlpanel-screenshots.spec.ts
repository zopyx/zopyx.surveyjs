...
test.describe('Forms Control Panel', () => {
  ...
  test('@@forms-settings - main settings', async ({ page }) => {
  ...
  test('@@forms-settings - AI settings section', async ({ page }) => {
    await page.goto('/@@forms-settings');
    await page.waitForLoadState('networkidle');
  ...
  test('@@forms-settings - Email settings section', async ({ page }) => {
    await page.goto('/@@forms-settings');
    await page.waitForLoadState('networkidle');
  ...
  test('@@forms-settings - Storage settings section', async ({ page }) => {
    await page.goto('/@@forms-settings');
    await page.waitForLoadState('networkidle');
...
test.describe('Plone Control Panels', () => {
  ...
  test('Site Setup overview', async ({ page }) => {
    await page.goto('/@@overview-controlpanel');
    await page.waitForLoadState('networkidle');
    
    await expect(page.locator('#content, .controlpanel-list')).toBeVisible();
    await page.waitForTimeout(500);
    
    await screenshots.capture('site-setup-overview', { fullPage: true });
  });

  test('Add-ons control panel', async ({ page }) => {
    await page.goto('/@@prefs_install_products_form');
    await page.waitForLoadState('networkidle');
