...
(function (global, factory) {
  ...
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global["i18n/greek"] = {}, global.SurveyCreatorCore));
  ...
  var grStrings = {
    ...
    p: {
      ...
      attachData: "Επισύναψη αρχικών στοιχείων",
      // Auto-generated string
      // "Choices"
      choices: "Επιλογές",
      // "Choices by url"
  ...
  surveyCreatorCore.setupLocale({ localeCode: "el", strings: grStrings });

  exports.grStrings = grStrings;
