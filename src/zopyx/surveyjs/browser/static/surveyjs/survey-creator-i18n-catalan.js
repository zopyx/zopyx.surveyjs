...
(function (global, factory) {
  ...
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global["i18n/catalan"] = {}, global.SurveyCreatorCore));
  ...
  var catalanTranslation = {
    ...
    ed: {
      ...
      lg: {
        ...
        itemExpressionText: "Cuando la expressió: '{0}' devuelve VERDADERO:",
        // {0} - the expression
        // "New rule"
        itemEmptyExpressionText: "Nova regla",
        // "make page {0} visible"
        page_visibilityText: "Hacer la pàgina {0} Visible",
        // {0} page name
        // "make panell {0} visible"
        panel_visibilityText: "Hacer panell {0} visible",
        // {0} panel name
        // "make panell {0} enable"
        panel_enableText: "Hacer panell {0} habilitar",
        // {0} panel name
        ...
        trigger_skipText: "Enquesta salta a la pregunta {0}",
        // {0} question name
        // "run expression: '{0}'"
        trigger_runExpressionText1: "Expressió de ejecución: '{0}'",
        // {0} the expression
    ...
    p: {
      ...
      surveyId: "ID de la enquesta",
      // Auto-generated string
      // [Auto-translated] "Survey post id"
      surveyPostId: "ID de publicación de la enquesta",
      // Auto-generated string
      // [Auto-translated] "Survey show data saving"
      surveyShowDataSaving: "La enquesta muestra el ahorro de datos",
      // Auto-generated string
      // [Auto-translated] "Question description alignment"
      ...
      questionTitlePattern: "Patrón de títol de pregunta",
      // Auto-generated string
      ...
      attachData: "Adjuntar elementos originales",
      // Auto-generated string
      // "Choices"
      choices: "opcions",
      // "Choices by url"
      choicesByUrl: "opcions por URL",
      // Auto-generated string
      // "Currency"
      currency: "divisa",
      // Auto-generated string
      ...
      allowAdaptiveActions: "Permitir accions adaptables",
      // Auto-generated string
      // "Default row value"
      defaultRowValue: "Valor por defecte Fila",
      // Auto-generated string
      ...
      choicesLazyLoadEnabled: "Opcions de carga diferida habilitadas",
      // Auto-generated string
      // [Auto-translated] "Choices lazy load page size"
      choicesLazyLoadPageSize: "Opcions de tamaño de pàgina de carga diferida",
      // Auto-generated string
      ...
      navigationTitle: "Títol de navegación",
      // Auto-generated string
      // [Auto-translated] "Navigation description"
      navigationDescription: "Descripció de navegación",
      // Auto-generated string
      ...
      acceptCarriageReturn: "Acceptar devolución de transporte",
      // Auto-generated string
      ...
      backgroundImageFit: "Ajuste de imatge de fondo",
      // Auto-generated string
      // [Auto-translated] "Background image attachment"
      backgroundImageAttachment: "Datos adjuntos de imatge de fondo",
      // Auto-generated string
  ...
  surveyCreatorCore.setupLocale({ localeCode: "ca", strings: catalanTranslation });

  exports.catalanTranslation = catalanTranslation;
