...
(function (global, factory) {
  ...
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global["i18n/mongolian"] = {}, global.SurveyCreatorCore));
  ...
  var mnStrings = {
    ...
    p: {
      ...
      attachData: "Эх элементүүдийг хавсаргах",
      // Auto-generated string
      // "Choices"
      choices: "Сонголтууд",
      // "Choices by url"
      ...
      choicesLazyLoadEnabled: "Сонголтууд lazy load идэвхжсэн",
      // Auto-generated string
      // [Auto-translated] "Choices lazy load page size"
      choicesLazyLoadPageSize: "Сонголтууд: залхуу ачаалах хуудасны хэмжээ",
      // Auto-generated string
      ...
      acceptCarriageReturn: "Тэрэгний буцаалтыг хүлээн авна",
      // Auto-generated string
      // "Display mode"
