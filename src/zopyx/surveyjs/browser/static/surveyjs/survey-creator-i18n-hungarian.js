...
(function (global, factory) {
  ...
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global["i18n/hungarian"] = {}, global.SurveyCreatorCore));
  ...
  var huStrings = {
    ...
    ed: {
      ...
      lg: {
        ...
        trigger_setvalueEmptyText: "Kérdésérték törlése: {0}",
        // {0} question name
    ...
    p: {
      ...
      attachData: "Eredeti elemek csatolása",
      // Auto-generated string
      // "Choices"
      choices: "Lehetőségek",
      // "Choices by url"
  ...
  surveyCreatorCore.setupLocale({ localeCode: "hu", strings: huStrings });

  exports.huStrings = huStrings;
