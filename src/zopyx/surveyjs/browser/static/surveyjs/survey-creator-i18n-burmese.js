...
(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('survey-creator-core')) :
  typeof define === 'function' && define.amd ? define(['exports', 'survey-creator-core'], factory) :
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global["i18n/burmese"] = {}, global.SurveyCreatorCore));
})(this, (function (exports, surveyCreatorCore) { 'use strict';
  ...
  var mmStrings = {
    ...
    ed: {
      ...
      lg: {
        ...
        itemExpressionText: "ဖော်ပြချက်: '{0}' မှ true ပြန်လာသည့်အခါ",
        // {0} - the expression
        // "New rule"
        itemEmptyExpressionText: "သစ်သောစည်းမျဉ်း",
        // "make page {0} visible"
        page_visibilityText: "စာမျက်နှာ {0} ကိုမြင်နိုင်စေပါ",
        // {0} page name
        // "make panel {0} visible"
        panel_visibilityText: "Panel {0} ကိုမြင်နိုင်စေပါ",
        // {0} panel name
        // "make panel {0} enable"
        panel_enableText: "Panel {0} ကိုဖွင့်ထားပါ",
        // {0} panel name
        // "make question {0} visible"
        question_visibilityText: "မေးခွန်း {0} ကိုမြင်နိုင်စေပါ",
        // {0} question name
        // "make question {0} enable"
        question_enableText: "မေးခွန်း {0} ကိုဖွင့်ထားပါ",
        // {0} question name
        // "make question {0} required"
        question_requireText: "မေးခွန်း {0} ကိုလိုအပ်အဖြစ်ပြုလုပ်ပါ",
        // {0} question name
        // "reset value for question: {0}"
        question_resetValueText: "မေးခွန်း: {0} အတွက်တန်ဖိုးကိုပြန်စဉ်ဆင်ပါ",
        // {0} question name.
        ...
        column_visibilityText: "မေးခွန်း {1} ၏ကော်လံ {0} ကိုမြင်နိုင်စေပါ",
        // {0} column name, {1} question name
        // "make column {0} of question {1} enable"
        column_enableText: "မေးခွန်း {1} ၏ကော်လံ {0} ကိုဖွင့်ထားပါ",
        // {0} column name, {1} question name
        // "make column {0} of question {1} required"
        column_requireText: "မေးခွန်း {1} ၏ကော်လံ {0} ကိုလိုအပ်အဖြစ်ပြုလုပ်ပါ",
        // {0} column name, {1} question name
        // "reset cell value for column: {0}"
        column_resetValueText: "ကော်လံ: {0} အတွက်တန်ဖိုးကိုပြန်စဉ်ဆင်ပါ",
        // {0} column name
        // "assign cell value: {1} to column: {0}"
        column_setValueText: "ကော်လံ: {0} သို့တန်ဖိုး: {1} ကိုထည့်ပါ",
        ...
        trigger_setvalueText: "မေးခွန်း: {0} ထဲသို့တန်ဖိုး {1} ကိုထည့်ပါ",
        // {0} question name, {1} setValue
        // "clear question value: {0}"
        trigger_setvalueEmptyText: "မေးခွန်း: {0} ၏တန်ဖိုးကိုရှင်းလင်းပါ",
        // {0} question name
        // "copy into question: {0} value from question {1}"
        trigger_copyvalueText: "မေးခွန်း {0} ထဲသို့ မေးခွန်း {1} မှတန်ဖိုးကိုကူးပါ",
        // {0} and {1} question names
        // "survey skip to the question {0}"
        trigger_skipText: "မေးခွန်း {0} သို့စစ်တမ်းကျော်သွားပါ",
        // {0} question name
        // "run expression: '{0}'"
        trigger_runExpressionText1: "ဖော်ပြချက်: '{0}' ကိုလုပ်ဆောင်ပါ",
        // {0} the expression
        // " and set its result into question: {0}"
        trigger_runExpressionText2: " နှင့်၎င်း၏ရလဒ်ကိုမေးခွန်း: {0} ထဲသို့ထည့်ပါ",
        // {0} question name
    ...
    p: {
      ...
      attachData: "မူရင်းအချက်အလက်များကိုထည့်ပါ",
      // Auto-generated string
      // "Choices"
      choices: "ရွေးချယ်မှုများ",
      // "Choices by url"
  ...
  surveyCreatorCore.setupLocale({ localeCode: "mm", strings: mmStrings });

  exports.mmStrings = mmStrings;
