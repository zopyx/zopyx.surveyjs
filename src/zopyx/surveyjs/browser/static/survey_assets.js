 ...
 * Used by survey_assets.pt (local resource bundle).
 */
/**
 * Initialize SurveyJS global variables from JSON config tags.
 */
(function initSurveyAssets() {
  /**
  ...
  var creatorBase = readValue("surveyjs-creator-i18n-base");
  if (creatorBase !== null) {
    window.SURVEYJS_CREATOR_I18N_BASE = creatorBase;
  }
})();
