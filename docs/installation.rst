...
* ``deno_releases.json`` — the pinned Deno version and SHA256 digests for the
  supported macOS/Linux x86_64 and arm64 artifacts.
...
reported version match ``deno_releases.json``. Windows is not currently
