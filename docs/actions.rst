...
Actions define what happens when a survey submission is received. Multiple
...
3. Subscribers execute enabled actions (store, mail, mail-notification, post).
...
- ``post`` does not block storage or mail; it executes in addition to those
